...
if (
    ...
    $result = $obj->select('*', 'productt', "product_name LIKE '{$product_name}'");
    if ($result->num_rows > 0) {
        ...
        $result = $obj->insert('productt', ['product_desc' => $desc, 'product_feature' => $feature, 'product_category' => $category_id, 'product_name' => $product_name, 'product_price' => $product_mrp, 'offer_price' => $price, 'product_stock' => $product_stock, 'company_profile_idcompany_profile' => $company, 'offer_idoffer' => $offer]);
